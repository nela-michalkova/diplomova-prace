...
I když od objevu prvního pulsaru uplynulo již více než půl století~\cite[s.~31]{ghosh2007}, stále nemáme uspokojivé odpovědi na řadu fundamentálních otázek. Zůstává například nejasné, jak přesně vypadá stavová rovnice hmoty při jaderných hustotách~\cite[s.~1]{baym2018}, nebo v jaké části hvězdy se nachází supratekutý rezervoár zodpovědný za glitche~\cite[s.~1]{andersson2021}. Propojení teoretických modelů s pozorovacími daty by mohlo přispět k lepšímu pochopení vztahu mezi rotací neutronových hvězd a supratekutostí v jejich nitru.


\section*{Cíle práce}
Budu upravovat
Hlavním tématem této práce je studium dynamiky glitche v neutronových hvězdách. Budeme vycházet z článku \textit{Glitch Rises as a Test for Rapid Superfluid Coupling in Neutron Stars} od Graber et al.~\cite{graber2018}. Jejich přístup využívá tříkomponentní hydrodynamický model, který neutronovou hvězdu rozděluje na supratekutou kůru, supratekuté jádro a takzvanou normální složku, která zahrnuje pevnou kůru a všechny částice, které jsou na ni pevně vázány. Toto rozdělení nám umožňuje sledovat dynamiku přenosu momentu hybnosti mezi jednotlivými složkami a to, jak se tento proces makroskopicky projeví na rotační křivce hvězdy během glitche~\cite[s.~4]{graber2018}.

Cílem práce je modifikovat existující výpočetní model vytvořený autory tohoto článku a systematicky prozkoumat závislost průběhu glitche na fyzikálních vlastnostech neutronové hvězdy. Zaměříme se především na to, jak konkrétní parametry hvězdy ovlivňují tvar a velikost glitchů. 

%Získané teoretické křivky následně porovnáme s dostupnými observačními daty. Zaměříme se především na přesná pulse-to-pulse měření z Vela pulsaru z prosince roku 2016, která představují dosud nejdetailnější záznam průběhu glitche~\cite[s.~1]{guvercinoglu2020, palfreyman2018}. Naším cílem je identifikovat, jaké kombinace teoretických parametrů nejlépe odpovídají skutečným pozorováním, a přispět tak k lepšímu pochopení interakcí probíhajících v nitru neutronových hvězd.%


%%%
\chapter{Neutronové hvězdy}

Neutronové hvězdy jsou extrémně kompaktní pozůstatky velmi hmotných hvězd, které vznikají po explozi supernovy (konkrétně typu II, Ib nebo Ic), kdy se jádro zhroutí vlivem vlastní gravitace~\cite[s.~1]{vidana2020}. Jejich hmotnost se pohybuje převážně okolo $1.4\,M_{\odot}$, přičemž poloměr je pouze $10$--$15\,\text{km}$. Tím dosahují hustot v řádu $10^{14}\,\text{g}\,\text{cm}^{-3}$, což z nich dělá jedny z nejhustších pozorovatelných objektů ve vesmíru~\cite[s.~1]{vidana2020}. Díky těmto vlastnostem vzniká v jejich okolí extrémně silné gravitační a magnetické pole. Vnitřek hvězdy tvoří převážně neutrony a nižší množství protonů a elektronů. O stabilitu se stará kombinace neutronového degeneračního tlaku a repulzivních jaderných interakcí na krátké vzdálenosti.


\section{Historie neutronových hvězd}
První zmínky o neutronových hvězdách sahají do třicátých let 20.~století. Krátce po objevu neutronu Chadwickem (1932) přišli W.~Baade a F.~Zwicky v roce 1934 s myšlenkou, že tyto kompaktní objekty mohou vznikat při explozích supernov~\cite[s.~39]{ghosh2007}. První výpočty hmotností a poloměrů těchto objektů s uplatněním obecné relativity provedli v roce 1939 J.~R.~Oppenheimer a G.~M.~Volkoff~\cite[s.~1]{ghosh2007}. Teorie neutronových hvězd však v následujících dvou desetiletích nezískala větší pozornost. Zčásti za to mohla mylná představa, že se neutronová jádra nemohou během hvězdného vývoje vůbec vytvořit, a zčásti také fakt, že původní motivace pro jejich studium, tedy hledání zdroje hvězdné energie, byla úspěšně vyřešena objevem termonukleární fúze~\cite[s.~1]{ghosh2007}.

Zájem o neutronové hvězdy se začal obnovovat až v 60.~letech s objevem extrasolárních diskrétních rentgenových zdrojů (Giacconi et al., 1962), které se původně interpretovaly jako tepelné záření z horkého povrchu čerstvě zrozených neutronových hvězd~\cite[s.~744]{ghosh2007}. K rozhodujícímu průlomu ale došlo až v roce 1967, kdy Jocelyn Bell a Antony Hewish objevili první rádiový pulsar (PSR B1919+21)~\cite[s.~2]{vidana2020}. Rychlé a vysoce stabilní pulzace poskytly přesné měřítko rotace. Brzy na to T.~Gold (1968) ukázal, že tyto objekty nemohou být nic jiného než rychle rotující, silně magnetizované neutronové hvězdy~\cite[s.~2]{vidana2020}. Definitivní potvrzení, že neutronové hvězdy tvoří také akreční systémy, přišlo v roce 1971 s objevem prvních rentgenových pulsarů, jako byl Cen~X-3~\cite[s.~744]{ghosh2007}. 

Celý tento vývoj, tedy od teoretických úvah ve 30. letech přes počáteční skepsi až po rozmach v 60. a 70. letech spojený s objevy rádiových a rentgenových pulsarů, položil pevné základy pro současné pochopení neutronových hvězd jakožto unikátních přírodních laboratoří. Dnes slouží ke studiu hmoty při supranukleárních hustotách, testování extrémních magnetických polí a modelování evoluce kompaktních objektů ve vesmíru~\cite[s.~1]{vidana2020}.



\section{Vnitřní struktura neutronové hvězdy}

Pro pochopení fyzikálních procesů uvnitř neutronových hvězd je nezbytné znát základní vrstvenou strukturu těchto objektů. Schematické znázornění jednotlivých oblastí od povrchových vrstev až po jádro je uvedeno na obr.~\ref{fig:nstar_vnitrni_struktura}.
...
Nejhlubší oblastí neutronové hvězdy je vnitřní jádro. To se obvykle spojuje s hustotami vyššími než přibližně $2\,\rho_0$ a sahá až k centrální hustotě $\rho_c$, která může dosahovat několikanásobku nukleární saturační hustoty, přibližně $4$--$7\,\rho_0$ \cite[s.~182]{ghosh2007}. Složení hmoty v této oblasti dosud není spolehlivě určeno, protože takto extrémní hustoty nelze přímo testovat v pozemských experimentech. Mezi možné formy hmoty ve vnitřním jádře patří hyperonová hmota, kaonové kondenzáty nebo dekonfinovaná kvarková hmota \cite[s.~5]{vidana2020}.
...
Základním nástrojem pro určení profilu tlaku, hustoty, hmotnosti a poloměru statické sféricky symetrické hvězdy je Tolmanova--\allowbreak{}Oppenheimerova--\allowbreak{}Volkoffova rovnice, která představuje relativistickou podmínku hydrostatické rovnováhy \cite[s.~84]{ghosh2007}.
...
Pro statický a sféricky symetrický prostoročas lze zvolit metriku ve tvaru
\begin{equation}
    ds^2 =
...
\end{equation}
Z těchto rovnic lze získat dvě nezávislé rovnice pro metrické funkce a rozložení hmoty. První z nich se obvykle zapisuje pomocí hmotnostní funkce $m(r)$, která udává hmotu-energii obsaženou uvnitř poloměru $r$ \cite[s.~84]{ghosh2007}. Zavedeme substituci
\begin{equation}
    e^{-2\beta(r)}
    =
    1 - \frac{2m(r)}{r}.
...
\end{equation}
Tento vztah ukazuje, že gravitační pole uvnitř hvězdy není určeno pouze hmotnostní funkcí $m(r)$, ale také tlakem $p(r)$. To je jeden ze zásadních rozdílů oproti Newtonovské teorii gravitace, kde tlak nevystupuje jako zdroj gravitačního pole \cite[s.~84]{ghosh2007}.
...
\end{equation}
Tento zápis ukazuje tři relativistické opravy vůči Newtonovské rovnici hydrostatické rovnováhy. Člen $p/c^2$ přispívá k efektivní hustotě, člen $4\pi r^3p/c^2$ vyjadřuje gravitační účinek tlaku a faktor $\left(1-2Gm/rc^2\right)^{-1}$ souvisí se zakřivením prostoročasu \cite[s.~84]{ghosh2007}.
...
\section{Vliv polohy rozhraní mezi jádrem a kůrou}
