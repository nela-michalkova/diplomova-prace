...
Neutronové hvězdy jsou extrémně kompaktní pozůstatky velmi hmotných hvězd, které vznikají po explozi supernovy (konkrétně typu II, Ib nebo Ic), kdy se jádro zhroutí vlivem vlastní gravitace~\cite[s.~1]{vidana2018}. Jejich hmotnost se pohybuje převážně okolo $1.4\,M_{\odot}$, přičemž poloměr je pouze $10$--$15\,\text{km}$. Tím dosahují hustot v řádu $10^{14}\,\text{g}\,\text{cm}^{-3}$, což z nich dělá jedny z nejhustších pozorovatelných objektů ve vesmíru~\cite[s.~1]{vidana2018}. Díky těmto vlastnostem vzniká v jejich okolí extrémně silné gravitační a magnetické pole. Vnitřek hvězdy tvoří převážně neutrony a nižší množství protonů a elektronů. O stabilitu se stará kombinace neutronového degeneračního tlaku a repulzivních jaderných interakcí na krátké vzdálenosti.

První zmínky o neutronových hvězdách sahají do třicátých let 20.~století. Krátce po objevu neutronu Chadwickem (1932) přišli W.~Baade a F.~Zwicky v roce 1934 s myšlenkou, že tyto kompaktní objekty mohou vznikat při explozích supernov~\cite[s.~60]{ghosh2007}. První výpočty hmotností a poloměrů těchto objektů s uplatněním obecné relativity provedli v roce 1939 J.~R.~Oppenheimer a G.~M.~Volkoff~\cite[s.~22]{ghosh2007}. Teorie neutronových hvězd však v následujících dvou desetiletích nezískala větší pozornost. Zčásti za to mohla mylná představa, že se neutronová jádra nemohou během hvězdného vývoje vůbec vytvořit, a zčásti fakt, že původní motivace, hledání zdroje hvězdné energie, byla úspěšně vyřešena objevem termonukleární fúze~\cite[s.~22]{ghosh2007}.

Zájem se začal obnovovat v 60.~letech s objevem extrasolárních diskrétních rentgenových zdrojů (Giacconi et al., 1962), které se původně interpretovaly jako tepelné záření z horkého povrchu čerstvě zrozených neutronových hvězd~\cite[s.~765]{ghosh2007}. K rozhodujícímu průlomu ale došlo až v roce 1967, kdy Jocelyn Bell a Antony Hewish objevili první rádiový pulsar (PSR B1919+21)~\cite[s.~2]{vidana2018}. Rychlé a vysoce stabilní pulzace poskytly přesné měřítko rotace. Brzy na to T.~Gold (1968) ukázal, že tyto objekty nemohou být nic jiného než rychle rotující, silně magnetizované neutronové hvězdy~\cite[s.~2]{vidana2018}. Definitivní potvrzení, že neutronové hvězdy tvoří také akreční systémy, přišlo v roce 1971 s objevem prvních rentgenových pulsarů, jako byl Cen~X-3~\cite[s.~765]{ghosh2007}. 

Celý tento vývoj – od teoretických úvah ve 30. letech přes počáteční skepsi až po rozmach v 60. a 70. letech spojený s objevy rádiových a rentgenových pulsarů – položil pevné základy pro současné pochopení neutronových hvězd jakožto unikátních přírodních laboratoří. Dnes slouží ke studiu hmoty při supranukleárních hustotách, testování extrémních magnetických polí a modelování evoluce kompaktních objektů ve vesmíru~\cite[s.~1]{vidana2018}.


\section{Vnitřní struktura neutronové hvězdy}

\subsection{Atmosféra}
...
\subsection{Glitche a pozorované data}
