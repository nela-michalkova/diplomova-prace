...
\section{Tříkomponentní dynamický model}

Neutronová hvězda je v kontextu dynamiky glitche rozdělena do několika rotačních komponent, které interagují s různou silou tření. Model použitý ve studii glitche pulsar Vela rozděluje hvězdu do tří hlavních součástí, aby mohl modelovat přenos úhlové hybnosti.

\subsection{Pevně vázaná složka}
...
\subsection{Neutronová supratekutina v kůře}
...
\section{Návaznost na model Graber et al.}

V článku od Vanessa Graber et al. (2024) se zaměřují na vliv supratekuté složky na rotaci pulsarů, přičemž používají fixní rozměr a hmotnost pulsaru, konkrétně používají hmotnost $1.4\,M_{\odot}$ a poloměr $10\,\text{km}$. My se zaměřujeme na to, jaký vliv má na rotaci pulsarů změna rozměru a hmotnosti pulsaru. Budeme používat model popsaný v článku, ale s tím rozdílem, že budeme měnit rozměr a hmotnost pulsaru.
