...
Složení: Zde se již volné neutrony nacházejí mičemimo atomová jádra. Hmota se skládá z neutronem bohatých jader, elektronového moře a superfluidních neutronů. Pasta fáze: V této vrstvě dochází v důsledku soupeření mezi nukleárními a Coulombovými silami k vytváření exotických struktur známých jako „nukleární pasta“ (např. tvary připomínající tyčinky, desky či bubliny).
...
\section{Porovnání s reálnými daty}
